...
4) For all variables, assess whether is_temporal, mergeKey, unitLabel, unitIRI, is_featured, hidden, scale, defaultDisplayRangeMin, defaultDisplayRangeMax, and defaultBinWidth should be completed
