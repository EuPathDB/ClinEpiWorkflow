...
ggsave(paste0("plots/uniqueVisitorsAWS", "_", todayFormated,".png", sep = ""), plot = uniqueVisitors)
```
...
ggsave(paste0("plots/visitsAWS", "_", todayFormated,".png", sep = ""), plot = visits)
```
...
ggsave(paste0("plots/usersGoogle", "_", todayFormated,".png", sep = ""), plot = usersGoogle)
```
...
ggsave(paste0("plots/sessionsGoogle", "_", todayFormated,".png", sep = ""), plot = sessionsGoogle)
```
...
ggsave(paste0("plots/studyMetricsByDisease", "_", todayFormated,".png", sep = ""), plot = studyMetricsByDiseasePlot)
...
ggsave(paste0("plots/studyMetricsByProject", "_", todayFormated,".png", sep = ""), plot = studyMetricsByProjectPlot)
...
ggsave(paste0("plots/studyMetricsByStudyDesign", "_", todayFormated,".png", sep = ""), plot = studySummary_byStudyDesignPlot)
